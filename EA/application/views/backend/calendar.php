                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="text" id="visitor-1-dl-state" class="form-control" maxlength="500"/>
                            </div> 
                    ...
                    <div class="row frame-content">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="visitor-2-dl-state" class="form-control" maxlength="500"/>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="visitor-3-dl-state" class="form-control" maxlength="500"/>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="visitor-4-dl-state" class="form-control" maxlength="500"/>
                            </div>            
